...
train_dataloader = dict(
    ...
    dataset=dict(
        ...
        data_mode=data_mode,
        data_root=data_root,
        ann_file='new_train_clothes_anno_dress.json',
        data_prefix=dict(img='dress/'),
...
val_dataloader = dict(
    ...
    dataset=dict(
        type=dataset_type,
        data_root=data_root,
        ann_file='new_test_clothes_anno_dress.json',
        data_prefix=dict(img='test_dress/'),
        test_mode=True,
...
val_evaluator = dict(
    type='CocoMetric',
    ann_file=data_root + 'test_clothes_anno_dress.json')
